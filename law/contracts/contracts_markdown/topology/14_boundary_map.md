# BoundaryMap Contract

## Classification
Subsystem: Topology / Algebraic Structure
Artifact Family: StructureArtifact
Role: Mathematical Object
Mathematical Object: BoundaryMap

## Contract
An algebraic map carrying a k-chain to its (k-1)-boundary.
...
* verify_boundarymap_invariants
* verify_carrier_bounds

## Witness Requirements
* BoundaryMapAdmissibilityWitness
