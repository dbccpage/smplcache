# ShortExactSequence Contract

## Classification
Subsystem: Homology
Artifact Family: StructureArtifact
Role: Mathematical Object
Mathematical Object: ShortExactSequence

## Contract
0→A→B→C→0 with mono then epi, exact in middle.
...
* verify_shortexactsequence_invariants
* verify_carrier_bounds

## Witness Requirements
* ShortExactSequenceAdmissibilityWitness
