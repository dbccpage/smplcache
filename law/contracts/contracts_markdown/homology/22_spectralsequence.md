# SpectralSequence Contract

## Classification
Subsystem: Homology
Artifact Family: StructureArtifact
Role: Mathematical Object
Mathematical Object: SpectralSequence

## Contract
pages E_r with differentials d_r and E_{r+1} ≅ H(E_r, d_r).
...
* verify_spectralsequence_invariants
* verify_carrier_bounds

## Witness Requirements
* SpectralSequenceAdmissibilityWitness
