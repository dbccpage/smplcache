...
Mathematical Object: CapProduct

## Contract
pairing between cochains and chains, compatible with boundaries.
...
* verify_capproduct_invariants
* verify_carrier_bounds

## Witness Requirements
* CapProductAdmissibilityWitness
