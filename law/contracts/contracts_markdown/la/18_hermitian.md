# HermitianMatrix Contract

## Classification
Subsystem: Linear Algebra
Artifact Family: StructureArtifact
Role: Mathematical Object / Operator
Mathematical Object: HermitianMatrix

## Contract
A complex square matrix that is equal to its own conjugate transpose (self-adjoint).
...
* verify_hermitianmatrix_invariants
* verify_carrier_bounds

## Witness Requirements
* HermitianMatrixAdmissibilityWitness
