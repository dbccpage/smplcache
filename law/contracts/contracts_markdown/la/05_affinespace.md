# AffineSpace Contract

## Classification
Subsystem: La
Artifact Family: StructureArtifact
Role: Mathematical Object
Mathematical Object: AffineSpace

## Contract
points form torsor over vectors: point difference is vector; point + vector is point.
...
* verify_affinespace_invariants
* verify_carrier_bounds

## Witness Requirements
* AffineSpaceAdmissibilityWitness
