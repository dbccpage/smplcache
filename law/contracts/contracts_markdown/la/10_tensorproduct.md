# TensorProduct Contract

## Classification
Subsystem: La
Artifact Family: StructureArtifact
Role: Mathematical Object
Mathematical Object: TensorProduct

## Contract
universal property: bilinear maps A×B→C correspond to linear maps A⊗B→C.
...
* verify_tensorproduct_invariants
* verify_carrier_bounds

## Witness Requirements
* TensorProductAdmissibilityWitness
