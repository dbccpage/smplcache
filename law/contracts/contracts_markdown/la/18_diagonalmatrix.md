# DiagonalMatrix Contract

## Classification
Subsystem: La
Artifact Family: StructureArtifact
Role: Mathematical Object
Mathematical Object: DiagonalMatrix

## Contract
multiplication commutes with diagonal scaling; cheap inverse if entries invertible.
...
* verify_diagonalmatrix_invariants
* verify_carrier_bounds

## Witness Requirements
* DiagonalMatrixAdmissibilityWitness
