...
Mathematical Object: Decomposition

## Contract
each decomposition has strict preconditions (SPD for Cholesky, etc.).
...
* verify_decomposition_invariants
* verify_carrier_bounds

## Witness Requirements
* DecompositionAdmissibilityWitness
