# SquareMatrix Contract

## Classification
Subsystem: La
Artifact Family: StructureArtifact
Role: Mathematical Object
Mathematical Object: SquareMatrix

## Contract
matrix ring; determinant defined (if commutative).
...
* verify_squarematrix_invariants
* verify_carrier_bounds

## Witness Requirements
* SquareMatrixAdmissibilityWitness
