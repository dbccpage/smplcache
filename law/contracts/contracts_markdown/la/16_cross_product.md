# CrossProduct Contract

## Classification
Subsystem: Linear Algebra
Artifact Family: StructureArtifact
Role: Mathematical Object / Operator
Mathematical Object: CrossProduct

## Contract
A bilinear, alternating vector product specific to 3-dimensional space (or 7-D) yielding a normal vector.
...
* verify_crossproduct_invariants
* verify_carrier_bounds

## Witness Requirements
* CrossProductAdmissibilityWitness
