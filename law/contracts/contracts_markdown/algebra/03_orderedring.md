# OrderedRing Contract

## Classification
Subsystem: Algebra
Artifact Family: StructureArtifact
Role: Mathematical Object
Mathematical Object: OrderedRing

## Contract
order compatible with + and × (for numeric LA).
...
* verify_orderedring_invariants
* verify_carrier_bounds

## Witness Requirements
* OrderedRingAdmissibilityWitness
