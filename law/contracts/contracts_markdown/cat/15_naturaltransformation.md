# NaturalTransformation Contract

## Classification
Subsystem: Cat
Artifact Family: StructureArtifact
Role: Mathematical Object
Mathematical Object: NaturalTransformation

## Contract
components η_A : F(A)→G(A) and naturality square commutes.
...
* verify_naturaltransformation_invariants
* verify_carrier_bounds

## Witness Requirements
* NaturalTransformationAdmissibilityWitness
