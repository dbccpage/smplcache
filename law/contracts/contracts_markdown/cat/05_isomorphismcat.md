# IsomorphismCat Contract

## Classification
Subsystem: Cat
Artifact Family: StructureArtifact
Role: Mathematical Object
Mathematical Object: IsomorphismCat

## Contract
f has inverse g with fg=id, gf=id.
...
* verify_isomorphismcat_invariants
* verify_carrier_bounds

## Witness Requirements
* IsomorphismCatAdmissibilityWitness
