# DirectImageSheaf Contract

## Classification
Subsystem: Sheaf
Artifact Family: StructureArtifact
Role: Mathematical Object
Mathematical Object: DirectImageSheaf

## Contract
pushforward; sections on V are sections on f^{-1}(V).
...
* verify_directimagesheaf_invariants
* verify_carrier_bounds

## Witness Requirements
* DirectImageSheafAdmissibilityWitness
