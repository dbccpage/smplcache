# RestrictionMap Contract

## Classification
Subsystem: Sheaf
Artifact Family: StructureArtifact
Role: Mathematical Object
Mathematical Object: RestrictionMap

## Contract
for inclusion U⊆V, res_{V→U}: F(V)→F(U).
...
* verify_restrictionmap_invariants
* verify_carrier_bounds

## Witness Requirements
* RestrictionMapAdmissibilityWitness
