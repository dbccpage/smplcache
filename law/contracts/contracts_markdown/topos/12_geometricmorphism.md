# GeometricMorphism Contract

## Classification
Subsystem: Topos
Artifact Family: StructureArtifact
Role: Mathematical Object
Mathematical Object: GeometricMorphism

## Contract
adjoint pair (f^*, f_*) with f^* left exact.
...
* verify_geometricmorphism_invariants
* verify_carrier_bounds

## Witness Requirements
* GeometricMorphismAdmissibilityWitness
