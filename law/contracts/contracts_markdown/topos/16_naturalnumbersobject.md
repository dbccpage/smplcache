# NaturalNumbersObject Contract

## Classification
Subsystem: Topos
Artifact Family: StructureArtifact
Role: Mathematical Object
Mathematical Object: NaturalNumbersObject

## Contract
object N with 0:1→N, s:N→N initial among such (primitive recursion).
...
* verify_naturalnumbersobject_invariants
* verify_carrier_bounds

## Witness Requirements
* NaturalNumbersObjectAdmissibilityWitness
