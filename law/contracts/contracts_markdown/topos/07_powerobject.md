# PowerObject Contract

## Classification
Subsystem: Topos
Artifact Family: StructureArtifact
Role: Mathematical Object
Mathematical Object: PowerObject

## Contract
object P(X) classifying subobjects of X (internal powerset).
...
* verify_powerobject_invariants
* verify_carrier_bounds

## Witness Requirements
* PowerObjectAdmissibilityWitness
