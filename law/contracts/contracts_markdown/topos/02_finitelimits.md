# FiniteLimits Contract

## Classification
Subsystem: Topos
Artifact Family: StructureArtifact
Role: Mathematical Object
Mathematical Object: FiniteLimits

## Contract
terminal object + pullbacks (+ equalizers).
...
* verify_finitelimits_invariants
* verify_carrier_bounds

## Witness Requirements
* FiniteLimitsAdmissibilityWitness
